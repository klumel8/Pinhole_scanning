function [gridcir]=GridGenFloSas(gridrow,gridcol)


rowleng=pi/gridrow; %Height of a row
colleng=2*pi/gridcol; %Width of a col

numberSteps = max(gridrow,gridcol)*7; %Number of steps of gamma
...
thetam = j*pi/gridrow; %Vector from 0 to pi- rowleng ; So theta is the collumn (y)
